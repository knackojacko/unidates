...
Questionnaire.create(q1:'Cat', q2:'Art', q3:'Drinks', q4:'Iphone', q5:'Books', q6:'Bali', q7:'Cafe', q8:'Board_Games', q9:'Walk_on_beach', q10:'Building_80_elevators', user_id: 1 )
Questionnaire.create(q1:'Dog', q2:'Art', q3:'Drinks', q4:'Iphone', q5:'Books', q6:'Bali', q7:'Cafe', q8:'Board_Games', q9:'Walk_on_beach', q10:'Building_80_elevators', user_id: 2 )
Questionnaire.create(q1:'Cat', q2:'Sport', q3:'Drinks', q4:'Iphone', q5:'Books', q6:'Bali', q7:'Cafe', q8:'Board_Games', q9:'Walk_on_beach', q10:'Building_80_elevators', user_id: 3 )
Questionnaire.create(q1:'Dog', q2:'Art', q3:'Clubbing', q4:'Iphone', q5:'Books', q6:'Bali', q7:'Cafe', q8:'Video_Games', q9:'Walk_on_beach', q10:'Building_80_elevators', user_id: 4 )

Questionnaire.create(q1:'Cat', q2:'Sport', q3:'Clubbing', q4:'Android', q5:'Movies', q6:'Paris', q7:'Restaurant', q8:'Video_Games', q9:'Walk_in_park', q10:'Building_80_escalators', user_id: 5 )
Questionnaire.create(q1:'Dog', q2:'Art', q3:'Clubbing', q4:'Android', q5:'Movies', q6:'Paris', q7:'Restaurant', q8:'Video_Games', q9:'Walk_in_park', q10:'Building_80_escalators', user_id: 6 )
Questionnaire.create(q1:'Dog', q2:'Art', q3:'Clubbing', q4:'Android', q5:'Movies', q6:'Paris', q7:'Restaurant', q8:'Video_Games', q9:'Walk_in_park', q10:'Building_80_escalators', user_id: 7 )
Questionnaire.create(q1:'Cat', q2:'Sport', q3:'Clubbing', q4:'Android', q5:'Movies', q6:'Paris', q7:'Restaurant', q8:'Video_Games', q9:'Walk_in_park', q10:'Building_80_escalators', user_id: 8 )
