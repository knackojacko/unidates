...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { answer1: @answer.answer1, answer2: @answer.answer2 } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { answer1: @answer.answer1, answer2: @answer.answer2 } }
